...
// Nueva función para registrar múltiples días
...
// Modificar la verificación para saber qué días ya están ocupados
function obtenerDiasRegistradosEstaSemana(userId) {
    // Lógica para obtener el lunes y domingo de la semana actual
    const hoy = new Date();
    ...
    return database.ref('asistencias')
        ...
        .then(snap => {
            ...
            snap.forEach(child => {
                ...
                if (data.fecha >= lunes && data.fecha <= domingo) {
